...
DataTableProps<TData, TValue>) {
	...
	const handleTotalRows = (totalRows: number) => {
		setTotalRows(totalRows);
		setPagination({ pageIndex: 0, pageSize: totalRows });
	};
		...
		<div className="w-full space-y-4">
			...
			<div className="flex items-center justify-between gap-4">
				<div className="relative flex-1 max-w-sm flex items-center gap-2">
					...
					<Select
						onValueChange={value => handleTotalRows(Number(value))}
						value={totalRows ? totalRows.toString() : undefined}
					>
						<SelectTrigger className="w-fit">
							<SelectValue placeholder="Rows per page"></SelectValue>
						</SelectTrigger>
						<SelectContent>
